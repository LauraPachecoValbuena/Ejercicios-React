//Fibonacci en clases  (opcion 2 usnado lifecycles, más recomendable.)
...
class App extends React.PureComponent<any, any> {
  ...
  //     this.setState({ value: fib(nextState.n) });
  //   }
  //   return true;
  // }
  ...
  //   }
  // }
  componentDidUpdate(_oldProps: any, oldState: any) {
    if (oldState.n !== this.state.n) {
      this.setState({ value: fib(this.state.n) });
    }
  }
  render() {
    return (
